<!-- ================================================Footer==================================== -->
  ...
  <div class="footer1 container-fluid" style="background-color: #212121; background-image: linear-gradient(to bottom, rgb(125, 125, 125), black);">
    <div class="row">
        <div class="footer1  col-md-3 d-flex align-items-start  px-5 justify-content-center flex-column py-5 text-light">
            ...
            <p>Communications, Media, and Information Services </p>
            <p>Education </p>
  ...
  <div class="footer2 container-fluid bg-black">
    <div class="row mt-5">
        ...
        <div class="footer_box2 my-4 col-md-3 text-light text-center  d-flex align-items-center justify-content-around">Privacy NoticeCookie PolicyDisclaimerSecurity PolicyCalifornia Notice at CollectionCustomize</div>
    </div>
  </div>
  </div>
